...
export const CreateIdentityInputSchema = z.object({
  ...
  state: z
    ...
    .default("active")
    .describe("Initial identity state"),
...
export const CreateRecoveryLinkInputSchema = z.object({
  ...
  expiresIn: z
    .string()
    .optional()
    .describe("Link validity duration (e.g., '1h', '24h')"),
});
...
export const SessionAnalyticsInputSchema = z.object({
  ...
  includeAuthMethods: z
    .boolean()
    .default(true)
    .describe("Include auth method distribution"),
  includeDevices: z
    .boolean()
    .default(true)
    .describe("Include device/browser breakdown"),
});
...
export const SessionAnalyticsOutputSchema = z.object({
  ...
  byAuthenticationMethod: z
    .record(z.number().int())
    .describe("Count by auth method"),
  byAssuranceLevel: z
    .object({
...
export const CredentialAnalyticsOutputSchema = z.object({
  ...
  credentialDistribution: z
    .record(z.number().int())
    .describe("Count by credential type"),
  mfaAdoption: z
    .object({
